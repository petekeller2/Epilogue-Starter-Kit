const config = {
  ...
  dbString: process.env.DATABASE_URL || 'postgres://postgres:<password>@localhost:5432/<db>',
  force: process.env.FORCE || 'YES', // YES to clear the db on server restart
  sessionSecret: process.env.SESSION_SECRET || '<SESSION_SECRET>',
  authOptionsDisabled: process.env.authOptionsDisabled || ['twitter'], // I prefer OAuth 2.0
  auth0: {
